...
class FailureDetector {
  ...
  ///
  /// [send] is a callback rather than a fixed action because its caller,
  /// [_handlePingReq], sends a bare relay Ping directly (see its closure
  /// for why not [_sendPing]), for now the only caller.
