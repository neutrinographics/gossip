...
///
/// [Ping] is sent periodically to the next peer in the probe rotation to
/// check if it's still reachable. The target should respond with an Ack
/// message containing the same sequence number.
///
