...
void main() {
  group('GossipCharacteristicUuids', () {
    test(
      'derives the data characteristic UUID by XORing the last byte with 0x01',
      () {
        final service = ServiceUuid('f0000000-0000-0000-0000-000000000000');
        final uuids = GossipCharacteristicUuids.derive(service);
        expect(
          uuids.dataCharacteristic,
          equals('f0000000-0000-0000-0000-000000000001'),
        );
      },
    );
    ...
    test('handles a non-zero last byte cleanly', () {
      ...
      expect(
        uuids.dataCharacteristic,
        equals('f0000000-0000-0000-0000-0000000000aa'),
      );
    });
